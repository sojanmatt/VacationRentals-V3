...
class OwnerSelectedPropertyDetail extends Component {
  constructor(props) {
    super(props);
  ...
  async componentDidMount() {
    ...
    //       this.state.currentPropId
    //   )
    //   .then(async response => {
    //     console.log(
    //       "owner selected property respone",
    //       response.data.value.properties[0]
    //     );
              ...
              <div className="form-inline">
                <div className="left-date" data-toggle="label">
                  <input
                    //  id="startDateInput"
                    type="date"
                    value={this.state.PropertyDetail.fromDate}
                ...
                <div className="form-group right-date" data-toggle="label">
                  <input
                    //  id="endDateInput"
                    type="date"
                    value={this.state.PropertyDetail.toDate}
...
export default withApollo(OwnerSelectedPropertyDetail);
